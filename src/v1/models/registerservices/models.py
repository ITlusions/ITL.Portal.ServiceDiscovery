...
class ServiceOnboarding:
    ...
    """
    def __init__(self, service_name: str, namespace: str, customer_id: Optional[str] = "unknown",
                 onboarding_status: Optional[str] = "discovered", metadata: Optional[Dict[str, str]] = None):
